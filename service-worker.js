const CACHE_NAME="ipt-v4.9.1";
const PRECACHE=[
  "./",
  "./index.html",
  "./wallet-core-v4.9.1.html",
  "./asset-center-v4.9.1.html",
  "./member-assets-v4.9.1.html",
  "./admin-assets-v4.9.1.html",
  "./admin-members-v4.9.1.html",
  "./print-report-v4.9.1.html",
  "./system-info-v4.9.1.html",
  "./maintenance-v4.9.1.html",
  "./update-center-v4.9.1.html",
  "./security-center-v4.9.1.html",
  "./security-ops-v4.9.1.html",
  "./event-center-v4.9.1.html",
  "./release.json",
  "./release-history.json",
  "./update-manifest-v4.9.1.json",
...
self.addEventListener("notificationclick",event=>{event.notification.close();const target=event.notification?.data?.url||"./event-center-v4.9.1.html?v=491";event.waitUntil(clients.matchAll({type:"window",includeUncontrolled:true}).then(list=>{for(const c of list){if("focus" in c){c.navigate(target).catch(()=>{});return c.focus()}}return clients.openWindow?clients.openWindow(target):undefined}))});
